...
See a Bootstrap 3.2.0 example [here](https://silviomoreto.github.io/bootstrap-select/3).

See a Bootstrap 2.3.2 example [here](https://silviomoreto.github.io/bootstrap-select) (deprecated).
