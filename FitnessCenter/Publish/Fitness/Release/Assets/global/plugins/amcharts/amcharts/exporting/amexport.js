AmCharts.AmExport = AmCharts.Class({
	...
	*/
	...
	@param base64_string
	@copyright Eli Grey, https://eligrey.com and Devin Samarin, https://github.com/eboyjr
	*/
	...
	*/
	generateSVG: function() {
		...
		context.setAttribute('xmlns', 'https://www.w3.org/2000/svg');
		context.setAttribute('xmlns:xlink','https://www.w3.org/1999/xlink');

		for (var i = 0; i < _this.processing.buffer.length; i++) {
			var group	= document.createElement('g'),
				data	= _this.processing.buffer[i];

			data[0].setAttribute('xmlns', 'https://www.w3.org/2000/svg');
			data[0].setAttribute('xmlns:xlink','https://www.w3.org/1999/xlink');
