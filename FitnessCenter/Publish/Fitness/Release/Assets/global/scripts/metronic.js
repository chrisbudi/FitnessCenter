    ...
    $.when(
        ...
        .done(function (result1, result2, result3, result4, result5, result6, result7) {
            ...
            Number.prototype.formatDecimal = function () {
                ...
                ////                console.log(globFormatter(this));
                //                console.log(globFormatter(Globalize.parseNumber(this.toString())));
                return globFormatter(parseFloat(this));
            }
...
//    });
    ...
    ////                    type: 'GET',
    ////                    async: false,
    ////                    url: "/Account/OpenLogOff"//"@Url.Action("OpenLogOff", "Account")"
    ////                });
    //            }
    //        }
    //    }
