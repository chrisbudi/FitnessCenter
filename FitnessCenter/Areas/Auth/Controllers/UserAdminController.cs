...
namespace FitnessCenter.Areas.Auth.Controllers
{
    ...
    public class UsersAdminController : FitController
    {
        ...
        {
            var dOffice = new DataServicePerson();

            var persons = dOffice.LoadAllData();
            return View(persons);
        }
        ...
        public async Task<ActionResult> Edit(
            [Bind(Include = "UserName,Id")] EditUserViewModel editUser,
            params string[] selectedGroups)
        {
            if (ModelState.IsValid)
            {
