...
namespace DataObjects.Configuration
{
    ...
    public class AspNetUserRoleConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<AspNetUserRole>
    {
        ...
        public AspNetUserRoleConfiguration(string schema)
        {
            ...
            HasRequired(a => a.AspNetRole).WithMany(b => b.AspNetUserRoles).HasForeignKey(c => c.RoleId).WillCascadeOnDelete();
            HasRequired(a => a.AspNetUser).WithMany(b => b.AspNetUserRoles).HasForeignKey(c => c.UserId).WillCascadeOnDelete();
        }
    }
